    ...
    },
    {
        ...
        "content": """
            ...
            <div style="background-color: #f8f9fa; padding: 15px; border-radius: 8px; margin-bottom: 20px;">
                <h6><strong>Aggregation Process & PHAC Data Access</strong></h6>
                <p><strong>PHAC only receives aggregated, anonymized data - never patient-level records</strong></p>
                
                <h6><strong>Aggregation Workflow</strong></h6>
                <ol>
                    <li>Extract immunization records from provincial FHIR repositories</li>
                    <li>De-identify data at PT level (removes all personal identifiers)</li>
                    <li>Categorize by jurisdiction, age group, gender, and vaccine type</li>
                    <li>Summarize dose counts and calculate total vaccinated individuals</li>
                    <li>Format into structured reports compliant with PHAC framework</li>
                </ol>
                
                <h6><strong>Key Aggregated Data Fields</strong></h6>
                <table style="width: 100%; border-collapse: collapse; margin-top: 10px; border: 1px solid #ddd;">
                    <thead style="background-color: #e9ecef;">
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="padding: 10px; border-bottom: 1px solid #ddd;">Date of immunization event (aggregate level)</td>
                        </tr>
                        <tr>
                            <td style="padding: 10px; border-bottom: 1px solid #ddd;">Jurisdiction</td>
                            <td style="padding: 10px; border-bottom: 1px solid #ddd;">Province where immunization was recorded</td>
                        </tr>
                        <tr>
                            <td style="padding: 10px; border-bottom: 1px solid #ddd;">Age Group</td>
                            <td style="padding: 10px; border-bottom: 1px solid #ddd;">Categorized age ranges (0-2, 3-5 years, etc.)</td>
                        </tr>
                        <tr>
                            <td style="padding: 10px; border-bottom: 1px solid #ddd;">Vaccine Type</td>
                            <td style="padding: 10px; border-bottom: 1px solid #ddd;">Type of vaccine administered (MMR, COVID-19, etc.)</td>
                        </tr>
                        <tr>
                            <td style="padding: 10px;">Dose Count</td>
                            <td style="padding: 10px;">Total doses administered in reporting period</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div style="background-color: #f8f9fa; padding: 15px; border-radius: 8px;">
                <h6><strong>Key Assumptions & Clarifications</strong></h6>
                <ul>
                    <li>PTs are fully responsible for de-identification before data sharing</li>
                    <li>PHAC never accesses raw patient-level data</li>
                    <li>Aggregation occurs entirely at PT level</li>
                    <li>PHAC receives only pre-aggregated, anonymized datasets</li>
                    <li>Data sovereignty is maintained through federated model</li>
                </ul>
            </div>
        """
    },
